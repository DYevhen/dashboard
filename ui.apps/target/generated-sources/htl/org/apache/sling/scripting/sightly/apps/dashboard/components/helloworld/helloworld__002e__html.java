 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.dashboard.components.helloworld;
...
out.write("\n    ");
_global_model = renderContext.call("use", com.exadel.core.models.HelloWorldModel.class.getName(), obj());
{
